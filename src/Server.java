    ...
    public void run()
    {
        if(this.name=="Owner") {
        	try {
				...
				System.out.println("Owner cleaned and closed the shop. See you tomorrow!");
				Thread.sleep(500);
				System.exit(0);
			} 
...
//    	Thread.sleep(500);
        ...
        System.out.println(this.name + ": Cafe Closed. I'm taking my leave now. Goodbye.");
        Thread.sleep(500);
    }
    ...
    { 
        this.closingTime = true;
            System.out.println(this.name + " : We're closing soon!");
    }
